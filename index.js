...
const nouns = ['apple', 'avocado', 'lemon', 'lime', 'orange', 'watermelon', 'carpool', 'cancellation', 'detour', 'no-show', 'rider', 'driver', 'waypoint', 'satisfaction', 'reliability', 'visibility', 'impact', 'favorite', 'itinerary', 'timeline', 'reimbursement', 'credit']
